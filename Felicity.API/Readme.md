...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Felicity.API*):
...
Execute unit tests
```
    cd "Felicity.API/test/Felicity.API.Tests"
    dotnet test
```

Deploy application
```
    cd "Felicity.API/src/Felicity.API"
